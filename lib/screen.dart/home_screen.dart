...
// import 'package:donwloader_video/screen.dart/meta_data.dart';
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Donwloader Video'),
//       ),
//       body: Container(
//         child: Flex(
...
//                             ),
//                             Text(
//                               title == null ? 'Nothing\'s here' : 'Title: $title',
...
//                             ),
//                             Visibility(
//                               visible: sizeInMp3 == null || sizeInMp3 == "" ? false : true,
//                               child: TextButton(
//                                 child: Text(
//                                   isDownloadingMp3
//                                       ? 'Downloading...'
...
//                             ),
//                             Visibility(
//                               visible: sizeInMp4 == null || sizeInMp4 == "" ? false : true,
//                               child: TextButton(
//                                 child: Text(
//                                   isDownloadingMp4
//                                       ? 'Downloading...'
//                                       : "Download MP4 ($qualityInMp4, $sizeInMp4)".toUpperCase(),
//                                   style: TextStyle(fontSize: 14),
//                                 ),
//                                 style: ButtonStyle(
//                                   padding: MaterialStateProperty.all<EdgeInsets>(
...
//                             ),
//                             Visibility(
//                               visible: progress == null || progress == "" ? false : true,
//                               child: Text(
...
//   //   try {
//   //     link = await FlutterYoutubeDownloader.extractYoutubeLink(youTube_link, null);
...
//   Future<void> downloadVideo(String trackURL, String trackName, String format) async {
//     setState(() {
...
//           trackName.replaceAll(new RegExp(r'[^\w\s]+'), '').split(" ").join("") +
//           format);
